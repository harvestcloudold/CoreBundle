...
/**
 * generate Seller*Windows
 *
 * @author Tom Haskins-Vaughan <tom@harvestcloud.com>
 * @since  2012-10-31
 */
class MakeSellerWindowsCommand extends ContainerAwareCommand
{
    /**
     * configure()
     *
    ...
    {
        $this
            ->setName('harvestcloud:core:make-seller-windows')
            ->setDescription('Make future Seller*Windows using WindowMakers')
            ->addOption('num-days', null, InputOption::VALUE_OPTIONAL, 'Number of days in future to create windows for', 14)
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $windowMakers = $this->getContainer()->get('doctrine')
            ->getRepository('HarvestCloudCoreBundle:SellerWindowMaker')
